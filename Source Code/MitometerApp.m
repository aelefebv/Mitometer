classdef MitometerApp < handle
    ...
    properties (Constant)
        AppPathBase = {'/Mitometer'};
        AppClass = 'MitometerApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            MitometerApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'GUI')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong GUI
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'GUI').getString, ...
